...
The fresh-target run is also the acceptance check for host ownership boundaries: Core hardening must work on the Ubuntu package baseline without claiming or blindly replacing distribution-owned configuration files.
