...
func coreTargetDirectories(adminUser string, operation OperationKind) []executionbundle.Directory {
	...
	return []executionbundle.Directory{
		...
		{Path: "/var/lib/vpsmith/core/authelia/data", Owner: executionbundle.PrincipalAdmin, Group: executionbundle.PrincipalAdmin, Mode: 0o750},
		{Path: "/var/lib/vpsmith/core/caddy", Owner: executionbundle.PrincipalRoot, Group: executionbundle.PrincipalAdmin, Mode: 0o750},
		{Path: "/var/lib/vpsmith/core/caddy/config", Owner: executionbundle.PrincipalAdmin, Group: executionbundle.PrincipalAdmin, Mode: 0o750},
		{Path: "/var/lib/vpsmith/core/caddy/data", Owner: executionbundle.PrincipalAdmin, Group: executionbundle.PrincipalAdmin, Mode: 0o750},
